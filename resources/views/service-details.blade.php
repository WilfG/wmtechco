...
<body>
    ...
    <div id="sticky-header" class="techno_nav_manu d-md-none d-lg-block d-sm-none d-none">
        <div class="container">
            <div class="row">
                <div class="menu">
                    <a href="index.html" class="logo"><img class="down" src="assets/images/1.png" alt=""> <img class="main_sticky" src="assets/images/logo.png" alt=""></a>
                    <ul class="clearfix">
                        <li><a href="#">Home</a>
                            <ul>
                                <li>
                                ...
                                <li>
                                    <ul>
                                        ...
                                        <li><a href="particle-01.html">Home Particle 01 <span>New</span></a></li>
                                        <li><a href="particle-02.html">Home Particle 02 <span>New</span></a></li>
                                        <li><a href="landing-1.html">Landing 01</a></li>
                                        <li><a href="landing-2.html">Landing 02</a></li>
                                        <li><a href="landing-3.html">Landing 03 <span>New</span></a></li>
                                        <li><a href="landing-4.html">Landing 04 <span>New</span></a></li>
                                        <li><a href="landing-5.html">Landing 05 <span>New</span></a></li>
                                    </ul>
                                </li>
                            </ul>
                        </li>
                ...
                <div class="col-lg-12">
                    <div class="breatcome_title">
                        ...
                        <div class="breatcome_content">
                            <ul>
                                <li><a href="index.html">Home</a> <i class="fa fa-angle-right"></i> <a href="#"> Pages</a> <i class="fa fa-angle-right"></i> <span>Service Details</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class=" col-lg-4 col-md-5 col-sm-12 col-xs-12">
                    <div class="service-details-pn-list">
                        <ul>
                            <li><a href="marketing-strategy.html">Marketing Strategy <span><i class="fa fa-angle-right"></i></span></a></li>
                            <li><a href="service-details.html">Digital Services <span><i class="fa fa-angle-right"></i></span></a></li>
                            <li><a href="product-selling.html">Product Selling <span><i class="fa fa-angle-right"></i></span></a></li>
                            <li><a href="interior-design.html">Interior Design <span><i class="fa fa-angle-right"></i></span></a></li>
                            <li><a href="product-design.html">Product Design <span><i class="fa fa-angle-right"></i></span></a></li>
                            <li><a href="social-marketing.html">Social Marketing <span><i class="fa fa-angle-right"></i></span></a></li>
                        </ul>
                    </div>
                    <div class="service-details-big-button mt-40 mb-40">
                        <a href="#"><span class="details-big-content">Company Presentation <i class="fa fa-long-arrow-right"></i></span></a>
                    </div>
                            ...
                            <div class="service-main-details">
                                <div class="service-main-details-inner">
                                    ...
                                    <div class="service-main-details-content-text pb-4">
                                        <p>There are many variations of passages of Lorem Ipsum available, but the majority have they an suffered alteration in some form, by injected humour, or randomised words which don’t looke even slightly believable.
                                            If you are going to use a passage of Lorem Ipsum, you need to be sure there isn’t anything embarrassing hidden in the middle</p>
                                        <p>There are many variations of passages of Lorem Ipsum available, but the majority have they an suffered alteration in some form, by injected humour, or randomised words which don’t looke even slightly believable.
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            ...
                            <div class="service-details-research">
                                ...
                                <div class="service-details-research-text">
                                    <p>There are many variations of passages of Lorem Ipsum available, but the majority have they an suffered alteration in some form, by injected humour, or randomised words which don’t looke even slightly believable. If
                                        you are going to use a passage of Lorem Ipsum, you need to be sure there isn’t anything embarrassing hidden in the middle</p>
