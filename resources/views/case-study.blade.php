...
<body>
                ...
                <div class="col-lg-12">
                    <div class="breatcome_title">
                        ...
                        <div class="breatcome_content">
                            <ul>
                                <li><a href="index.html">Home</a> <i class="fa fa-angle-right"></i> <a href="#"> Pages</a> <i class="fa fa-angle-right"></i> <span>Case Study</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <!--==================================================-->
    <!----- Start Techno Case Study One Area ----->
    <!--==================================================-->
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="case_study_style_two mb-30">
                        ...
                        <div class="case_study_style_two_content">
                            <div class="case_study_style_two_title">
                                <h4><a href="case-study-details.html">Solution For Business</a></h4>
                                <span>Marketing / Design</span>
                            </div>
                            <div class="case_study_style_two_button pt-3">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="case_study_style_two mb-30">
                        ...
                        <div class="case_study_style_two_content">
                            <div class="case_study_style_two_title">
                                <h4><a href="case-study-details.html">Solution For Company</a></h4>
                                <span>Marketing / Design</span>
                            </div>
                            <div class="case_study_style_two_button pt-3">
                                <a href="case-study-details.html">Read More</a>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="case_study_style_two mb-30">
                        ...
                        <div class="case_study_style_two_content">
                            <div class="case_study_style_two_title">
                                <h4><a href="case-study-details.html">Company Business Solution</a></h4>
                                <span>Marketing / Design</span>
                            </div>
                            <div class="case_study_style_two_button pt-3">
                                <a href="case-study-details.html">Read More</a>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="case_study_style_two mb-30">
                        ...
                        <div class="case_study_style_two_content">
                            <div class="case_study_style_two_title">
                                <h4><a href="case-study-details.html">Solution For Design</a></h4>
                                <span>Marketing / Design</span>
                            </div>
                            <div class="case_study_style_two_button pt-3">
                                <a href="#">Read More</a>
    ...
    <!--==================================================-->
    <!----- End Techno Case Study One Area ----->
    <!--==================================================-->
